...
C       **********************************
        ...
        SUBROUTINE CHEBYH(N,X,CP)
C
C       ============================================
C       Purpose: Compute Chebyshev coefficient as
C                used in INVEIX
C       Input  : N  --- Order
C                X  --- Argument of CHEBYH
C       Output:  CP --- Chebyshev coefficients
C       ============================================
C
...
C       **********************************
        ...
        SUBROUTINE INVEIX(X, XINVEI)
C
C       ============================================
C       Purpose: Compute inverse exponential
C                integral INVEIX
C       Input  : X  --- Argument of INVEIX
C       Output:  XINVEI --- InvEi(x)
C       ============================================
        IMPLICIT REAL*8(A-H,O-Z)
        DIMENSION A(18),B(40),C(31),D(20),E(12),CP(40)
        DATA D0,D02,D1,D4/ 0.0D0, 0.2D+00, 0.1D+01, 0.4D+01/
        DATA D10/ 0.1D+02/
        DATA DD,AL,AR/ -0.4D+02, 0.5526204223185710D+01, 0.14D+01/
        
        DATA CL,CR/ 0.2302585092994046D+03, 0.2333333333333333D+01/
        DATA TTSIX,TTTHI,TTSEF/ 1.0D+06, 1.0D+30, 1.0D+75/
        DATA GAMA,XLIM/ 0.5772156649015329D0, -0.17964D+03/
        DATA A0/ 0.6437886526479751D+00/
        DATA A/ 0.9064386988346374D-01, 0.9300656002466609D-02,
     &          0.1113491174545628D-02, 0.1449533716892655D-03,
     &          0.1988574369724217D-04, 0.2827655349851211D-05,
     &          0.4126838266145942D-06, 0.6143055402345404D-07,
     &          0.9287011017152234D-08, 0.1421607322198230D-08,
     &          0.2198527476112263D-09, 0.3429293049174355D-10,
     &          0.5388084044634395D-11, 0.8518763671398946D-12,
     &          0.1354194440489523D-12, 0.2164350839154000D-13,
     &          0.3559329319126644D-14, 0.5585025007902728D-15/
        DATA B0/0.1830677242643788D+01/
        DATA B/ 0.1342334080845767D+01,-0.1622912194628387D+00,
     &         -0.1540653182590032D-01, 0.2146974208276341D-01,
     &         -0.8683094134424091D-02, 0.1749088088820356D-02,
     &          0.2519344943099614D-03,-0.3917234144040935D-03,
     &          0.1829543708587281D-03,-0.4428635694379090D-04,
     &         -0.3193518192376903D-05, 0.8975463790086726D-05,
     &         -0.4771153059686919D-05, 0.1351403284187416D-05,
     &         -0.1134158040138728D-07,-0.2205686541394063D-06,
     &          0.1348244035003366D-06,-0.4387205070635919D-07,
     &          0.3451640678529175D-08, 0.5481760349425335D-08,
     &         -0.3945281175861268D-08, 0.1457243627565196D-08,
     &         -0.2022508300419465D-09,-0.1320353227574422D-09,
     &          0.1169671725660033D-09,-0.4874296440255150D-10,
     &          0.9331396122790289D-11, 0.2907708496403671D-11,
     &         -0.3466228785896828D-11, 0.1628934793131851D-11,
     &         -0.3896495189995959D-12,-0.5053502712552324D-13,
     &          0.1015775593895423D-12,-0.5413205628463380D-13,
     &          0.1538484578678585D-13, 0.1943158157649840D-15,
     &         -0.2889693960319969D-14, 0.1724909755580719D-14,
     &         -0.5051389429307347D-15, 0.4192090591476265D-16/
        DATA C0/ 0.9926100854427894D+00/
        DATA C/ -0.2632830948123372D-01,-0.1022773914981291D-01,
     &           0.2887448679232107D-02, 0.8739173184297346D-03,
     &          -0.2372539776429675D-03,-0.2427815188243921D-05,
     &           0.1226361363920155D-04,-0.3981653868890148D-05,
     &           0.7770998140099518D-06, 0.9740072426011362D-07,
     &          -0.1722188446233942D-06, 0.8454936641650443D-07,
     &          -0.2483925751249633D-07, 0.2933950266945880D-08,
     &           0.1710389687599002D-08,-0.1456199008611630D-08,
     &           0.6502562140599764D-09,-0.1928339070563551D-09,
     &           0.2553918845919601D-10, 0.1270406011818610D-10,
     &          -0.1226939586161727D-10, 0.6220818135183033D-11,
     &          -0.2298325109069916D-11, 0.6041917472772795D-12,
     &          -0.6156146399085977D-13,-0.4910984262416599D-13,
     &           0.4274224870016564D-13,-0.2193291198755495D-13,
     &           0.8703513501477785D-14,-0.2738400003355100D-14,
     &           0.5986864896134004D-15/
        DATA D00/ 0.9983431518385018D+00/
        DATA D/ -0.1727189196111757D-02,-0.2471671561950342D-03,
     &           0.2847045882079321D-05,-0.1375863536928200D-05,
     &           0.8288722390418689D-07,-0.2045951582574949D-07,
     &           0.2645420011735580D-08,-0.4030167931899867D-09,
     &           0.1408004116369951D-09,-0.2305665521400702D-10,
     &           0.3661501283048828D-11,-0.1643009793932417D-11,
     &           0.4706465783921404D-12,-0.7303591850228056D-13,
     &           0.1805538158066223D-13,-0.9048989795515730D-14,
     &           0.2913910150332786D-14,-0.5595065672189281D-15,
     &           0.1358855772109000D-15,-0.5393468214221121D-16/
        DATA E0/0.9999010777235023D+00/
        DATA E/ -0.7510839150580935D-04,-0.7213908151533009D-05,
     &           0.9239091216393431D-07,-0.3576061982304842D-08,
     &           0.1772785718360568D-09,-0.1297310533448326D-10,
     &           0.1203568183719573D-11,-0.1313833893582293D-12,
     &           0.1605159259412034D-13,-0.2130289620205136D-14,
     &           0.3075573168863437D-15,-0.4460153922052597D-16/
        IF(X.LE.XLIM) THEN
            XINVEI=D0
        ELSE IF(X.LE.DD) THEN
            XINVEI=DEXP(X-GAMA)
        ELSE IF(X.LT.D0) THEN
            ARC=DEXP(X)
            ARC=ARC/(ARC+D1)
            ARG=D4*ARC-D1
            CALL CHEBYH(18,ARG,CP)
            XINVEI=A0
            DO 10 I=1,18
                XINVEI=XINVEI+A(I)*CP(I)
10          CONTINUE
            XINVEI=XINVEI*ARC
        ELSE IF(X.LE.D10) THEN
            ARG=D02*X-D1
            CALL CHEBYH(40,ARG,CP)
            XINVEI=B0
            DO 20 I=1,40
                XINVEI=XINVEI+B(I)*CP(I)
20          CONTINUE
        ELSE IF(X.LE.TTSIX) THEN
            ARL=DLOG(X)
            ARG=(AL/ARL)-AR
            CALL CHEBYH(31,ARG,CP)
            XINVEI=C0
            DO 30 I=1,31
                XINVEI=XINVEI+C(I)*CP(I)
30          CONTINUE
            XINVEI=XINVEI*DLOG(X*ARL)
        ELSE IF(X.LE.TTTHI) THEN
            ARL=DLOG(X)
            ARG=(BL/ARL)-BR
            CALL CHEBYH(20,ARG,CP)
            XINVEI=D00
            DO 40 I=1,20
                XINVEI=XINVEI+D(I)*CP(I)
40          CONTINUE
            XINVEI=XINVEI*(ARL+DLOG(ARL+DLOG(ARL)))
        ELSE IF(X.LE.TTSEF) THEN
            ARL=DLOG(X)
            ARG=(CL/ARL)-CR
            CALL CHEBYH(12,ARG,CP)
            XINVEI=E0
            DO 50 I=1,12
                XINVEI=XINVEI+E(I)*CP(I)
50          CONTINUE
            XINVEI=XINVEI*(ARL+DLOG(ARL+DLOG(ARL)))
        ELSE
            XINVEI=XLIM
